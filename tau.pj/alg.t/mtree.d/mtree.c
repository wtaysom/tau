...
void insert_sibling (branch_s *parent, void *sibling, s64 k, u64 key)
{
	snint		slot;
FN;
...
int delete_leaf (tree_s *tree, leaf_s *leaf, u64 key)
{
	rec_s	*r;
FN;
	r = find_rec(leaf, key);
...
int search_node (tree_s *tree, void *node, u64 key, search_f sf, void *data);
