...
function runtest(x) {
	...
	case 4:	// Fat lines
		...
		ctx.strokeRect(50, 50, 100, 100);
		break;
	case 5:	// Using clear to clear part of the drawing
		ctx.fillRect(50, 50, 100, 100);
		ctx.fillStyle = "rgb(255, 0, 0)";
	...
	case 10:	// Translation
		...
		ctx.restore();
		break;
	case 11:	// Scaling - multiplies everything by scalling factors
		ctx.save();
		ctx.translate(100, 100);
		ctx.scale(2, 2);
		ctx.fillRect(0, 0, 100, 100);
		ctx.restore();
		break;
	case 12:	// Rotation - rotates around origin
		ctx.save();
	...
	if (false) ctx.clearRect(0, 0, canvas.width, canvas.height);
}
